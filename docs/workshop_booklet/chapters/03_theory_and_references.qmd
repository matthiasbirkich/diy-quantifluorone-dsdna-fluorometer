...
where $begin:math:text$c$end:math:text$ is the DNA concentration, $begin:math:text$V$end:math:text$ is the selected DNA volume, and $begin:math:text$L$end:math:text$ is the representative DNA fragment length in base pairs.
