...
Lambda DNA contains 48,502 bp and has a molecular mass of approximately 32 MDa. Thus, 1 ng of intact $\lambda$-DNA corresponds to approximately 0.032 fmol, or about 32 fmol per µg.

The DNA mass contained in a selected volume is calculated from its mass concentration:

$$m\;(\mathrm{ng}) = c\;(\mathrm{ng/\mu L}) \times V\;(\mathrm{\mu L})$$

The corresponding molar amount can then be estimated from the DNA mass and fragment length:

$$n_{\mathrm{DNA}}\;(\mathrm{fmol}) \approx \frac{m\;(\mathrm{ng}) \times 10^{6}}{650 \times L\;(\mathrm{bp})}$$

Combining both steps gives a direct conversion from the fluorometrically determined mass concentration:

$$n_{\mathrm{DNA}}\;(\mathrm{fmol}) \approx \frac{c\;(\mathrm{ng/\mu L}) \times V\;(\mathrm{\mu L}) \times 10^{6}}{650 \times L\;(\mathrm{bp})}$$

where $begin:math:text$c$end:math:text$ is the DNA concentration, $begin:math:text$V$end:math:text$ is the selected DNA volume, and $begin:math:text$L$end:math:text$ is the DNA fragment length in base pairs.

At this stage of the workflow, the known example is the supplied Promega $\lambda$-DNA stock at 400 ng/µL. A volume of 1 µL therefore contains:

$$m = 400\;\mathrm{ng/\mu L} \times 1\;\mathrm{\mu L} = 400\;\mathrm{ng}$$

For intact 48,502-bp $\lambda$-DNA:

$$n_{\mathrm{DNA}} \approx \frac{400 \times 10^{6}}{650 \times 48{,}502} \approx 12.7\;\mathrm{fmol}$$

Thus, 1 µL of the 400 ng/µL $\lambda$-DNA stock contains 400 ng DNA but only approximately 12.7 fmol of intact $\lambda$-DNA molecules. The same DNA mass would represent a much larger molar amount if the DNA were present as shorter fragments.

**PCR context:** For the downstream PCR workflow, approximately 100 fmol DNA template is targeted, with 80 fmol used as the minimum acceptable input where specified by the PCR protocol. This requirement cannot be derived from the fluorometric concentration alone: conversion from ng/µL to fmol also requires the volume used and an appropriate representative DNA fragment length.
