...
Commercially available $\lambda$-DNA is a 48,502-bp linear dsDNA molecule with a molecular mass of approximately 32 MDa. Consequently, 1 ng $\lambda$-DNA corresponds to approximately 0.032 fmol, or about 32 fmol per µg.

For dsDNA of a known or representative fragment length, the molar amount can be estimated from its mass:

$$n_{\mathrm{DNA}}\;(\mathrm{fmol}) \approx \frac{m\;(\mathrm{ng}) \times 10^{6}}{650 \times L\;(\mathrm{bp})}$$

At this stage of the workflow, the only known DNA concentration is the supplied Promega $\lambda$-DNA stock of 400 ng/µL. Thus, 1 µL of this stock contains 400 ng $\lambda$-DNA, corresponding to approximately 12.7 fmol of intact 48,502-bp $\lambda$-DNA.

This illustrates an important distinction between mass concentration and molar amount: the same DNA mass represents many more molecules when the DNA fragments are shorter. Later, after the concentration of an unknown sample has been measured, its DNA mass can first be calculated from concentration and sample volume and then converted to an approximate molar amount using an appropriate representative fragment length.

**PCR context:** If the downstream PCR workflow specifies a target of approximately 100 fmol DNA template (and, where applicable, a minimum input of 80 fmol), this requirement must not be inferred directly from the fluorometric concentration alone. The conversion requires both the measured DNA mass and an appropriate estimate of the fragment length.
