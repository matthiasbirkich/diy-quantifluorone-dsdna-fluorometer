...
## Software files in the repository
...
> > **Important:** "stable RC2" describes the tested firmware package and operating workflow. The documented multipoint calibration and analytical workflow have been evaluated using the validation procedure described in Chapter 10.
...
## Reset timing: three different results
...
### Slow double-click: required for file maintenance
...
### Fast double-click: UF2 bootloader mode
...
## Check or update the UF2 bootloader
...
## Clean installation of QuantiFluorONE stable RC2

This is the current recommended workshop procedure.

### Prepare the firmware folder
...
### Copy the complete stable release
...
## First startup and hardware check
...
The display may show `cal=none c=uncalibrated` until a calibration is loaded or created. After loading a compatible calibration, verify that the calibration information displayed by the instrument corresponds to the calibration intended for the current measurement series.

## CSV and JSON write behaviour
...
## Updating or reinstalling the same supported release
