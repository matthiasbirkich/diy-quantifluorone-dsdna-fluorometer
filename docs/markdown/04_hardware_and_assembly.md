...
![Assembled DIY-QuantiFluorONE prototype during a firmware and display check. The displayed measurement is not presented as analytical validation data.](../figures/assembled_instrument_front.jpg){width=65%}
...
![Main electronic, optical, mechanical, and laboratory components
used to assemble and operate the DIY-QuantiFluorONE-dsDNA-Fluorometer.](../figures/qfo_complete_component_set.jpg)
...
![CAD overview of the PyBadge enclosure and instrument base.](../figures/pybadge_enclosure_cad.jpeg){width=65%}

![CAD overview of the optical module mounted on the instrument base.](../figures/optical_module_overview_cad.jpeg){width=65%}
...
![Excitation side of the optical module showing PartC with the **installed** 485 nm LED and Ex470BP-40 excitation filter.](../figures/excitation_side_led_filter.jpg){width=65%}
...
![Detection side of the optical module showing the Em532BP-40 emission filter and TSL2591 sensor.](../figures/detection_side_filter_sensor.jpg){width=65%}

## Correct 90° optical geometry

![Optical geometry of the instrument.](../figures/qfo_optical_geometry.png)
...
![Component placement of the ioRodeo `radial_16mA` fixed-current LED board, revision `ver_0p1_rev_3`. The drawing identifies the principal components used for visual inspection and assembly verification.](../figures/iorodeo_radial_16mA_assembly.png)
...
![Interior view of the assembled instrument showing the PyBadge, PCA9546 I²C multiplexer, modified ioRodeo LED board, TSL2591 sensor and internal wiring.](../figures/open_instrument_wiring.jpg){width=65%}

## STEMMA QT / Qwiic wiring and I²C addresses

![Electronics overview. The TSL2591 may be connected to any available downstream PCA9546 channel. The firmware scans the downstream channels for the sensor at address `0x29`; therefore, a fixed downstream channel assignment is not required.](../figures/qfo_electronics_overview.png)
...
![Complete measurement setup including the DIY-QuantiFluorONE-dsDNA-Fluorometer, Promega QuantiFluor® ONE dsDNA System, pipettes, PCR tubes and the supporting laboratory equipment used for routine measurements.](../figures/measuring_setup.jpg)
