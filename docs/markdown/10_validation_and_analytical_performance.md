...
![Two-point-calibrated DIY fluorometer results shown as technical triplicate mean ± SD. Marker size was reduced so that the error bars remain visible. The shaded band is the 95% confidence band of the independent linear regression. The square identifies the upper calibration anchor.](../figures/two_point_calibrated_diy_results_with_sd_and_confidence_band.png){#fig-ch10-linearity-sd}
...
![Two-point-calibrated DIY fluorometer results shown as technical triplicate mean ± 95% confidence interval. The shaded band is again the 95% confidence band of the independent regression. These intervals describe the uncertainty of the three consecutive sensor readings within one measurement cycle; they do not represent independently prepared assay replicates.](../figures/two_point_calibrated_diy_results_with_95CI_and_confidence_band.png){#fig-ch10-linearity-ci}
...
![Bland–Altman agreement plot for the independent validation results. The solid line marks the mean bias, and the dashed lines mark the approximate 95% limits of agreement.](../figures/quantus_diy_bland_altman_v2.png){#fig-ch10-bland-altman}
...
![Primary and confirmatory blank-based LOD and LOQ estimates.](../figures/blank_based_lod_loq_summary.png){#fig-ch10-blank-limits}
